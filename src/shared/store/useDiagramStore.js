...
export const useDiagramStore = create((set) => ({
  ...
  nodes: {
    contact: {
      label: 'contact',
      content:
        '<h3>Contact</h3>\n<p>Email: <a>sehyun030526@gmail.com</a></p>\n',
      position: {
        x: 429,
        y: -297,
      },
    ...
    'getting-started': {
      ...
      content:
        "<h1>Getting Started</h1>\n<p>Let's begin your Codiagram journey!</p>\n",
      position: {
        x: -66,
        y: 132,
      },
    ...
    intro: {
      label: 'intro',
      content:
        "<h1>Welcome to Codiagram! 👋</h1>\n<p>Hi, I'm <strong>Sehyun</strong>,</p>\n<p>Thank you for using my Codiagram service.</p>\n<p>I hope you enjoy working with <code>Codiagram</code>!</p>\n",
      position: {
        x: -66,
        y: -297,
      },
